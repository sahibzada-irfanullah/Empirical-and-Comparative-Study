...
class Word2vec_Rules_Features:
    ...
    def show_message(self):
        print("show message feature feature_extraction irfan")
    ...
    -Takes attributes,responses, vect_type(simple by default), minDF, maxDF'''
        ...
        if vect_type.lower() not in ["word2vec", "glove_word2vec", "word2vec_glove", "gloveword2vec", "word2vecglove", \
            ...
            save_vect.save_Model(fun_word_to_vec_map_word2vec, word2vecLabel_word2vec.replace('Vect', 'Model'), word2vecLabel_word2vec.replace('Vect', 'Model'))
            ...
            save_vect.save_Model(fun_word_to_vec_map_doc2vec, word2vecLabel_doc2vec.replace('Vect', 'Model'), word2vecLabel_doc2vec.replace('Vect', 'Model'))
